...
if ($pagina == 'apagar'){
    ...
    if($btnCadUsuario){
        ...
        if ($checkresultado['nome'] != $dados['nome']){
            ...
            $resultildo = mysqli_query($conn, "DELETE FROM entrada WHERE (`matricula` = '".$dados['matricula']."')");
...
<body>
    <center>
        ...
        <?php
            ...
            <form method="POST" action="">
                <label>Matrícula</label>
                <input type="matricula" name="matricula" placeholder="Digite a matrícula do aluno">
                <label>Senha</label>
